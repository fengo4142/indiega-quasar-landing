<template>
  <q-page>
          ...
          <div class="table-row">
            <div class="table-cell valign-middle text-left">
              <a href="index.html" class="logo">
                <img src="statics/images/logo.png" alt class="img-responsive inline-block" />
              </a>
            </div>
            ...
            <div class="table-cell valign-top text-right">
              <div class="right-bl">
                ...
                <a href="#" class="btn header-btn ml25 color-white hidden-sm hidden-xs">Join us Now</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="main-slider">
      <div id="n2-ss-4-align" class="n2-ss-align">
        <div class="n2-padding">
          <div
            ...
            data-min-font-sizedesktop-portrait="1"
            data-min-font-sizedesktop-landscape="1"
            data-min-font-sizetablet-portrait="1"
            data-min-font-sizetablet-landscape="1"
            data-min-font-sizemobile-portrait="1"
            data-min-font-sizemobile-landscape="1"
              ...
              <div class="n2-ss-slider-2 n2-ow">
                <div class="n2-ss-slider-3 n2-ow" style>
                  ...
                  <div
                    ...
                    data-id="15"
                    style
                    class="n2-ss-slide n2-ss-canvas n2-ow n2-ss-slide-15"
                  >
                    <div class="n2-ss-slide-background n2-ow" data-mode="fill">
                      <img
                        data-hash="7f12344252192edee35072e997e65114"
                        data-desktop="statics/plugins/slider/images/slide-1.jpg"
                        data-blur="0"
                        data-opacity="100"
                        data-x="50"
                        data-y="50"
                        src="statics/plugins/slider/images/slide-1.jpg"
                        alt
                      />
                    </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            ...
                            data-desktopportraitfontsize="100"
                            data-tabletportraitfontsize="80"
                            data-mobileportraitfontsize="90"
                            data-plugin="rendered"
                          >
                          ...
                          >
                            ...
                            >
                              <a
                                class="n2-style-588404275f372121297e39cfe0b03e24-heading n2-ow"
                  ...
                  <div
                    ...
                    data-id="16"
                    style
                    class="n2-ss-slide n2-ss-canvas n2-ow n2-ss-slide-16"
                  >
                    <div class="n2-ss-slide-background n2-ow" data-mode="fill">
                      <img
                        data-hash="df538617dc01fb19a0bb4e642cc11f2d"
                        data-desktop="statics/plugins/slider/images/slide-2.jpg"
                        data-blur="0"
                        data-opacity="100"
                        data-x="50"
                        data-y="50"
                        src="statics/plugins/slider/images/slide-2.jpg"
                        alt
                      />
                    </div>
                    <div class="n2-ss-layers-container n2-ow" data-csstextalign="center" style>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <div class="n2-ow n2-ow-all n2-ss-desktop n2-ss-mobile n2-ss-tablet">
                              <p class="n2-font-7753338b51c1a1442e4b2825494fb15e-paragraph n2-ow">
                                Rump biltong buffalo kielbasa bresaola strip steak frankfurter bacon
                  ...
                  <div
                    ...
                    data-id="17"
                    style
                    class="n2-ss-slide n2-ss-canvas n2-ow n2-ss-slide-17"
                  >
                    <div class="n2-ss-slide-background n2-ow" data-mode="fill">
                      <img
                        data-hash="daeb09696afe190d4a842f033c14d69b"
                        data-desktop="statics/plugins/slider/images/slide-3.jpg"
                        data-blur="0"
                        data-opacity="100"
                        data-x="50"
                        data-y="50"
                        src="statics/plugins/slider/images/slide-3.jpg"
                        alt
                      />
                    </div>
                    <div class="n2-ss-layers-container n2-ow" data-csstextalign="center" style>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <div class="n2-ow n2-ow-all n2-ss-desktop n2-ss-mobile n2-ss-tablet">
                              <p class="n2-font-7753338b51c1a1442e4b2825494fb15e-paragraph n2-ow">
                                Spare ribs venison swine tenderloin flank, ribeye pastrami jowl kielbasa
                                ham tongue meatloaf.
      ...
      <div
        id="n2-ss-4-placeholder"
        style="position: relative;z-index:2;color:RGBA(0,0,0,0);max-height:3000px;"
      >
        <img
      ...
      <div class="container">
        <div class="row">
          <div class="title-bl text-center wow fadeIn" data-wow-duration="2s">
            <div class="title color-white">UpComing Games:</div>
          ...
          <div class="tm-tabs tabs mt70">
              ...
              <ul class="list-inline nav nav-tabs tabs-slider">
                <li class="active col-lg-3 col-md-3">
                  <a href="#tab-item-1" data-toggle="tab">
                    <div class="img-wrap">
                      <img src="statics/images/game-img-1.jpg" alt />
                    </div>
                    <div class="nav-header-bl mt25">
                      <div class="nav-title color-white">Fifal 2018</div>
                ...
                <li class="col-lg-3 col-md-3">
                  <a href="#tab-item-2" data-toggle="tab">
                    ...
                    <div class="nav-header-bl mt25">
                      <div class="nav-title color-white">Mix Combination</div>
                ...
                <li class="col-lg-3 col-md-3">
                  <a href="#tab-item-3" data-toggle="tab">
                    ...
                    <div class="nav-header-bl mt25">
                      <div class="nav-title color-white">Forza Jacson</div>
                ...
                <li class="col-lg-3 col-md-3">
                  <a href="#tab-item-4" data-toggle="tab">
                    ...
                    <div class="nav-header-bl mt25">
                      <div class="nav-title color-white">NO MAN’S SKY</div>
                      <div class="date">Sept 15, 2019</div>
                    </div>
                  </a>
                </li>
                <li class="col-lg-3 col-md-3">
                  <a href="#tab-item-5" data-toggle="tab">
                    ...
                    <div class="nav-header-bl mt25">
                      <div class="nav-title color-white">NO MAN’S SKY 2</div>
                      <div class="date">Sept 15, 2019</div>
                    </div>
                  </a>
                </li>
            ...
            <div class="tab-content relative mt90">
              <div class="tab-pane fade active in text-left clearfix" id="tab-item-1">
                <div
                  class="tab-info col-lg-6 col-md-12 col-sm-12 col-xs-12 ptb90 pl100 equal-height"
                >
                  <div class="tab-head table uppercase fsize-14 fweight-700">
                    <div class="table-cell valign-middle ws-20 color-1">New games action</div>
                    <div class="table-cell valign-middle text-right">Apr 25-27, 2018</div>
                  </div>
                  <div
                    class="uppercase fsize-32 fweight-700 font-agency color-white lheight-normal"
                  >Fifal 2018</div>
                  <div class="mt50 lheight-26 fweight-300">
                    <p>
                      Andouille frankfurter hamburger, swine leberkas tenderloin cupim. Ground round ball tip
                      pastrami, turducken chicken porchetta fatback frankfurter. Pig kielbasa jowl strip.
                    </p>
                    <p>
                      Steak sausage pork loin bacon tri-tip meatball shoulder cupim beef pork chop kevin boudin.
                      Short loin pig meatball ham landjaeger pastrami. Drumstick ham hock chuck pork belly
                      chicken prosciutto biltong salami ham pancetta.
                    </p>
                  </div>
                  <div class="mt60 table g-bottom">
                    <div class="table-cell valign-middle">
                      <a
                        href="single-game.html"
                ...
                <div class="tab-img col-lg-6 col-md-12 col-sm-12 col-xs-12 pr0 equal-height">
                  <div class="image-bl">
                    <img class="game-full-img" src="statics/images/game-slide-img-1.jpg" alt />
                  </div>
                </div>
              </div>
    ...
    <section class="blog-section ptb90">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="title-bl text-center wow fadeIn" data-wow-duration="2s">
              <div class="title color-white">Our latest Posts:</div>
              <div class="subtitle">Frash news</div>
            </div>
          ...
          <div class="row">
            <div class="item col-lg-4 col-md-4 col-sm-12 col-sx-12">
              <a href="/" class="item-wrap">
                <div class="image">
                  <img src="statics/images/blog-img-1.jpg" alt class="img-responsive" />
                </div>
                <div class="item-info equal-height">
                  ...
                  <div
                    class="item-title mt20"
                    data-trim="40"
                  >Cow biltong pork belly kielbasa shankle</div>
                  <div
                    class="item-text mt25 lheight-26"
                    data-trim="130"
                  >Turducken cupim hamburger beef ribs picanha, drumstick buffalo tri-tip cow. Turducken prosciutto shank pork chop.</div>
                </div>
            ...
            <div class="item col-lg-4 col-md-4 col-sm-12 col-sx-12">
              <a href="/" class="item-wrap">
                <div class="image">
                  <img src="statics/images/blog-img-2.jpg" alt class="img-responsive" />
                </div>
                <div class="item-info equal-height">
                  <div class="item-header table fsize-14 fweight-700 uppercase">
            ...
            <div class="item col-lg-4 col-md-4 col-sm-12 col-sx-12">
              <a href="/" class="item-wrap">
                <div class="image">
                  <img src="statics/images/blog-img-3.jpg" alt class="img-responsive" />
                </div>
                <div class="item-info equal-height">
                  <div class="item-header table fsize-14 fweight-700 uppercase">
                  ...
                  <div
                    class="item-title mt20"
                    data-trim="40"
                  >Boudin shankle pork belly turducken spare rib</div>
                  <div
                    class="item-text mt25 lheight-26"
                    data-trim="130"
                  >Capicola chicken rump biltong boudin corned beef prosciutto short loin pork chop fatback flank beef porchetta tenderloin.</div>
                </div>
                <div class="author-comment table">
                  <div class="table-cell valign-middle">
                    <i class="fa fa-user color-1 fsize-14" aria-hidden="true"></i>
    ...
    <section class="pt90 pb170">
      <div class="container">
        <div class="row">
          <div class="title-bl text-center wow fadeIn" data-wow-duration="2s">
            <div class="title color-white">Testimonials:</div>
          ...
          <div class="testimonial-slider testimonial-tpl mt100">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="slide-item">
                <div class="author-img">
                  <img src="statics/images/testimonials/testimonial-author-1.jpg" alt />
                </div>
                <div class="text-center">
                  <i class="fa fa-quote-left" aria-hidden="true"></i>
                  <div
                    class="fsize-24 fweight-700 color-white font-agency uppercase"
                  >Birdie Stephens</div>
                  <div class="color-1 fsize-14 fweight-700 uppercase">Gamer</div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="slide-item">
                <div class="author-img">
                  <img src="statics/images/testimonials/testimonial-author-2.jpg" alt />
                </div>
                <div class="text-center">
                  <i class="fa fa-quote-left" aria-hidden="true"></i>
                  <div
                    class="fsize-24 fweight-700 color-white font-agency uppercase"
                  >Miguel Carpenter</div>
                  <div class="color-1 fsize-14 fweight-700 uppercase">Gamer</div>
                  <div class="fsize-20 italic mt40">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="slide-item">
                <div class="author-img">
                  <img src="statics/images/testimonials/testimonial-author-3.jpg" alt />
                </div>
                <div class="text-center">
                  <i class="fa fa-quote-left" aria-hidden="true"></i>
                  <div class="fsize-24 fweight-700 color-white font-agency uppercase">Martha Jones</div>
                  <div class="color-1 fsize-14 fweight-700 uppercase">Gamer</div>
                  <div
                    class="fsize-20 italic mt40"
                  >«Hamburger pork beef shank turducken drumstick pork loin. Pork short ribs rump fatback capicola ham strip steak.»</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="gallery main-gallery ptb150">
      <div class="container">
        <div class="row">
          <div class="title-bl text-center wow fadeIn" data-wow-duration="2s">
            <div class="title color-white">Screenshots gallery</div>
            <div class="subtitle">All New Images</div>
          </div>
        </div>
        <div class="row">
          <div class="grid-wrapper mt70">
            <div class="filter_container text-center">
              ...
              <div class="filter-item" data-filter="origin">Origin</div>
              <div class="filter-item" data-filter="playstation-4">Playstation 4</div>
              <div class="filter-item" data-filter="steam">Steam</div>
              <div class="filter-item" data-filter="uplay">Uplay</div>
              <div class="filter-item" data-filter="xbox-one">Xbox one</div>
            </div>
            <div class="item_container relative mt40">
              <div class="item origin col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="item-content">
                  <div class="image-bl">
                    <img src="statics/images/gallery/gallery-1.jpg" alt />
                  </div>
                  <div class="item-info">
                    <div class="info-bl text-center">
                      <a
                        href="#"
                        data-trim="40"
                        class="item-title color-white fsize-24 fweight-700 font-agency uppercase"
                      >Using Banner Stands To Increase Trade</a>
              ...
              <div class="item playstation-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="item-content">
                  <div class="image-bl">
                    <img src="statics/images/gallery/gallery-2.jpg" alt />
                  </div>
                  <div class="item-info">
                    <div class="info-bl text-center">
                      <a
              ...
              <div class="item uplay col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="item-content">
                  <div class="image-bl">
                    <img src="statics/images/gallery/gallery-4.jpg" alt />
                  </div>
                  <div class="item-info">
                    <div class="info-bl text-center">
                      <a
              ...
              <div class="item steam xbox-one col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <div class="item-content">
                  <div class="image-bl">
                    <img src="statics/images/gallery/gallery-3.jpg" alt />
                  </div>
                  <div class="item-info">
                    <div class="info-bl text-center">
                      <a
              ...
              <ul class="list-inline nav nav-tabs">
                <li class="active col-lg-4 col-md-4 col-sm-12 col-xs-12">
                  <a href="#stream-1" data-toggle="tab">
                    <div class="tab-title">Most popular streams</div>
                  </a>
                </li>
                <li class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                  <a href="#stream-2" data-toggle="tab">
                    <div class="tab-title">Upcoming Competitions</div>
                  </a>
                </li>
                <li class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                  <a href="#stream-3" data-toggle="tab">
                    <div class="tab-title">Prosciutto meatball flank</div>
                  </a>
                </li>
              </ul>
            </div>
            <div class="tab-content stream-bl relative">
              <div class="tab-pane fade active in text-left clearfix" id="stream-1">
                <div class="left-col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div
                    class="video-bl equal-height"
                    data-vide-bg="mp4: http://denysthemes.com/html/riliant/assets/video/earth.mp4, webm: http://denysthemes.com/html/riliant/assets/video/earth.webm, ogv: http://denysthemes.com/html/riliant/assets/video/earth.ogv, poster: statics/images/585x550.jpg"
                  ...
                  >
                    ...
                    <div class="video-bottom">
                      <div class="video-title">Tenderloin shoulder picanha rump</div>
                      <div class="mt15">
                        <div class="stream-img">
                          <img src="statics/images/stream-img-1.jpg" alt />
                        </div>
                        <div class="stream-img">
                          <img src="statics/images/stream-img-2.jpg" alt />
                        </div>
                        <div class="stream-img">
                          <img src="statics/images/stream-img-3.jpg" alt />
                        </div>
                        <div class="inline-block valign-middle color-white ml15">2569 watching now</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="right-col col-lg-6 col-md-6 col-sm-12 col-xs-12 equal-height">
                  <div class="top-wrapp">
                    <div
                      class="fsize-24 fweight-700 font-agency color-white uppercase lheight-28"
                    >Create Your own channel and Start to Stream games now</div>
                    ...
                    <a href="#" class="btn gradient color-white plr40 ptb19 mt30">Get started now</a>
                  </div>
                  <div class="bottom-wrapp mt40">
                    <div
                      class="fsize-24 fweight-700 font-agency uppercase color-white"
                    >9 136 streams from most recent games</div>
              ...
              <div class="tab-pane fade in competition text-left clearfix" id="stream-2">
                <div class="left-col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div
                    class="image_bg equal-height"
                    style="background-image: url('statics/images/competition-full.jpg');"
                  >
                    <div class="bottom-bar">
                      <a href="#" class="btn gradient color-white plr50 ptb19">Contact us now</a>
                    </div>
                  </div>
                </div>
                <div class="right-col col-lg-6 col-md-6 col-sm-12 col-xs-12 equal-height">
                  <div class="item-g">
                    <div class="img-com inline-block valign-middle">
                      <img src="statics/images/competition-1.jpg" alt />
                    </div>
                    <div class="info-bl inline-block valign-middle ml25">
                      <div
                        class="fsize-24 fweight-700 font-agency uppercase color-white"
                        data-trim="35"
                      >Shankle ribeye bacon</div>
                      <div>267 347 participants</div>
                    </div>
                  </div>
                  <div class="item-g">
                    <div class="img-com inline-block valign-middle">
                      <img src="statics/images/competition-2.jpg" alt />
                    </div>
                    <div class="info-bl inline-block valign-middle ml25">
                      <div
                        class="fsize-24 fweight-700 font-agency uppercase color-white"
                        data-trim="35"
                      >Doner bresaola pork Kielbasa</div>
                      <div>267 347 participants</div>
                    </div>
                  </div>
                  <div class="item-g">
                    <div class="img-com inline-block valign-middle">
                      <img src="statics/images/competition-3.jpg" alt />
                    </div>
                    <div class="info-bl inline-block valign-middle ml25">
                      <div
                        class="fsize-24 fweight-700 font-agency uppercase color-white"
                        data-trim="35"
                      >Kielbasa fatback alcatr</div>
                      <div>267 347 participants</div>
                    </div>
                  </div>
                  <div class="item-g">
                    <div class="img-com inline-block valign-middle">
                      <img src="statics/images/competition-4.jpg" alt />
                    </div>
                    <div class="info-bl inline-block valign-middle ml25">
                      <div
                        class="fsize-24 fweight-700 font-agency uppercase color-white"
                        data-trim="35"
                      >Bacon tenderloin drumstick meatball</div>
                      <div>267 347 participants</div>
                    </div>
                  </div>
                </div>
    ...
    <section class="price ptb150">
      <div class="container">
        <div class="row">
          <div class="title-bl text-center wow fadeIn" data-wow-duration="2s">
            <div class="title color-white">Our Pricing Plans</div>
            <div class="subtitle">Spesial Plans</div>
          </div>
          <div class="mt90">
            <div
              class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeInLeft"
              data-wow-duration="2s"
            >
              <div class="item standart text-center">
                <div
                  class="ptb30 fsize-24 fweight-700 font-agency uppercase color-white"
                >Standard Plan</div>
                <div class="current-bl color-white pt25 pb20">
                  ...
                  <div class="fsize-14 uppercase fweight-700">Per mouth</div>
                </div>
            ...
            <div
              class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeInDown"
            ...
            <div
              class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeInRight"
              data-wow-duration="2s"
            >
    ...
    <section class="ptb150">
      <div class="container">
        <div class="row">
          <div class="title-bl text-center wow fadeIn" data-wow-duration="2s">
            <div class="title color-white">Requently Asked Questions</div>
            <div class="subtitle">You should know this</div>
          </div>
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 wow fadeInLeft">
            <div class="reg-wrapper">
              <div class="title-bl text-left">
                <div class="title color-white">Register for our Newsletter now</div>
                <div class="subtitle">Newslatter</div>
              </div>
              <div class="color-white">We are always ready to welcome you!</div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="copyright ptb30 col-lg-12">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">© Copyright 2018</div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">All Rights Reserved</div>
          </div>
        </div>
      </div>
    </footer>
